...
var ObjectMall = {
  ...
  1: {
    ...
    _use: function _use() {
      ...
      this.owner.getScene().time.delayedCall(3000, function () {
        _this.owner.base_vel /= 2;
      });
    }
  },
  "2": {
  ...
  "3": {
    ...
    _use: function _use() {
      ...
      while (not_avail) {
        var x = Math.random() * 1900 + 16;
        var y = Math.random() * 1900 + 16; // @ts-ignore

        var map = this.scene.layer3.tilemap;
  ...
  "4": {
    ...
    intro: "畫面閃動特效1秒",
    key: "glove",
    _use: function _use() {// this.scene.cameras.main.shake(1000);
    }
  },
  "5": {
    _id: "5",
